      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            >
              Born from a vision in our second year of B.Tech, our event
              management platform aims to revolutionize how college communities
              organize and experience events. Now in our third year, we&apos;re
            ...
            >
              Our goal is to create a seamless, intuitive platform that brings
              people together, fostering vibrant college communities. We&apos;re
              starting local, but our ambitions are set on broader horizons.
            </motion.p>
          </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-gray-400 mb-6 text-lg font-light highlight-text">
          {role}
        </p>
