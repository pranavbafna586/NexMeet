...
const eventSchema = z.object({
  ...
  event_price: z
    ...
    .transform(Number)
    .refine((price) => price >= 0, "Price cannot be negative"),
  ...
  organizer_contact: z
    ...
    .regex(
      /^\+?[1-9]\d{1,14}$/,
      "Invalid phone number format. It should be a valid international number."
    ),
          ...
          <>
              ...
              <input
                ...
                value={
                  event.event_startdate
                    ? new Date(event.event_startdate).toISOString().slice(0, 16)
                    : ""
                }
                onChange={(e) =>
            ...
            <div className="flex flex-col w-full gap-2">
              ...
              <input
                ...
                value={
                  event.event_enddate
                    ? new Date(event.event_enddate).toISOString().slice(0, 16)
                    : ""
                }
                onChange={(e) =>
            ...
            <div className="flex flex-col w-full gap-2">
              ...
              {fieldErrors.event_price && (
                <p className="text-red-500">{fieldErrors.event_price}</p>
              )}
            </div>
            <div className="flex flex-col w-full gap-2">
            ...
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="event_social_links">
                Event Social Links (comma separated):{" "}
              </label>
              <input
                type="text"
                ...
                onChange={(e) =>
                  setEvent({
                    ...event,
                    event_social_links: e.target.value
                      .split(",")
                      .map((link) => link.trim()),
                  })
                }
            ...
            <AlertDialog>
              ...
              >
                ...
                <AlertDialogFooter>
                  <AlertDialogCancel className="bg-gray-200 hover:bg-red-600 text-black rounded-md px-4 py-2">
                    Cancel
                  </AlertDialogCancel>
                  <AlertDialogAction
                    onClick={handleUpdateEvent}
                    className="bg-gray-200 border hover:bg-green-600 text-black rounded-md px-4 py-2"
                  >
                    Update
                  </AlertDialogAction>
                </AlertDialogFooter>
