...
const EventPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#15132A] text-white">
          ...
          <div key={space.id} className="space-y-12 mt-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-8">
                {/* About Space */}
                <div className="bg-[#15132A] border border-white rounded-xl p-8 space-y-6">
                        ...
                        <span className="mr-2 text-[#FFC107]">
                          ...
                          >
                            <path
                              ...
                              strokeWidth="2"
                              d="M12 2.25l3.3 6.6 7.2.3-5.5 4.8 2 7.05L12 16.5l-6.95 4.5 2-7.05L2.25 9.15l7.2-.3L12 2.25z"
                            />
                          </svg>
                        </span>
                        About Space
              ...
              <div className="space-y-8">
                {/* Owner Details */}
                <div className="bg-[#15132A] border border-white rounded-xl p-6 space-y-4">
                  <h2 className="text-xl font-bold">Owner Details</h2>
                  <div className="space-y-2 text-gray-300">
                    <div className="flex flex-col gap-2">
                      <p className="flex items-center gap-2">
                        <PhoneIcon className="w-4 h-4 text-[#FFC107] dark:text-[#FF5733]" />{" "}
                        {space.owner_contact}
                      </p>
                      <p className="flex items-center gap-2">
                        <MailIcon className="w-4 h-4 text-[#28A745] dark:text-[#17A2B8]" />{" "}
                        {space.owner_email}
                      </p>
                    </div>
                  </div>
